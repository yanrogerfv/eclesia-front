...
export default function LandingPage() {
    ...
    return (
        <div className="h-full bg-gradient-to-b from-black to-primary/10">
            <main className="px-20 h-lvh justify-center items-center">
                ...
                <div className="justify-center items-center">
                    <div className="flex justify-center p-8">
                        <Button variant={"outfill"} className="flex h-[10dvh] w-[20dvh] outline outline-1 outline-primary bg-black/50 text-4xl rounded-xl"><Link href="/v0" className="w-full">Planejar</Link></Button>
                    </div>
