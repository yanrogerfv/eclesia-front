                ...
                <main className="px-4 sm:px-6 md:px-10 lg:px-20 py-8 sm:py-16 md:py-32 min-h-screen flex flex-col justify-center">
                    ...
                    <div className="flex justify-center mb-8 md:mb-12">
                        <div className="w-fit max-w-md ">
                            <div className="flex flex-col sm:flex-row justify-center items-center border shadow-lg text-black bg-white/10 backdrop-blur-sm">
                    ...
                    <div className="flex justify-center mb-8 md:mb-12">
                        <div className="max-w-xs sm:max-w-md md:max-w-xl px-4">
                    ...
                    <div className="flex justify-center ">
                        <Card className="w-[95%] sm:w-[90%] md:w-[80%] max-w-4xl border border-primary/75 flex justify-between items-center px-6 py-2 sm:py-1 bg-cardstartbg/80 gap-2 sm:gap-0">
                            <Popover>
                                <PopoverTrigger asChild>
                                    <p className="text-xs sm:text-sm text-colortext cursor-pointer hover:underline">v1.1.0</p>
                                </PopoverTrigger>
