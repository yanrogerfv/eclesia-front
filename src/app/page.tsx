    ...
    return (
        ...
        // <div style={{ backgroundImage: "url('https://i.imgur.com/dk8EP9v.jpeg')" }} 
            ...
            <main className="px-4 sm:px-10 md:px-20 h-lvh justify-center items-center">
                <nav className={"outline outline-1 outline-primary bg-card/80 h-[8dvh] rounded-b-3xl "} />
                <nav className="pt-8 md:pt-16 flex justify-center">
                    <div className="flex-row justify-center text-center p-6 md:p-10 outline outline-1 outline-primary rounded-xl bg-card/80">
                ...
                <div className="justify-center items-center">
                    ...
                    <div className="flex text-center justify-center pb-5 pt-10 sm:pt-20">
                        <Card className="w-[90%] sm:w-[80svh] outline outline-1 items-center outline-primary flex justify-between px-3 py-1 bg-card/80">
